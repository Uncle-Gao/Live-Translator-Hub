...
> GUI full-scene real-time localization engine covering Cursor and Claude desktop apps, with Webview plugin penetration and AI async translation support.

[日本語](docs/readme/ja-JP.md) | [한국어](docs/readme/ko-KR.md) | [Français](docs/readme/fr-FR.md) | [Deutsch](docs/readme/de-DE.md) | [Español](docs/readme/es-ES.md) | [Italiano](docs/readme/it-IT.md) | [Português](docs/readme/pt-BR.md) | [Português](docs/readme/pt-PT.md) | [Nederlands](docs/readme/nl-NL.md) | [Polski](docs/readme/pl-PL.md) | [Svenska](docs/readme/sv-SE.md) | [Dansk](docs/readme/da-DK.md) | [Suomi](docs/readme/fi-FI.md) | [Norsk](docs/readme/nb-NO.md) | [Čeština](docs/readme/cs-CZ.md) | [Slovenčina](docs/readme/sk-SK.md) | [Română](docs/readme/ro-RO.md) | [Magyar](docs/readme/hu-HU.md) | [Ελληνικά](docs/readme/el-GR.md) | [Български](docs/readme/bg-BG.md) | [Українська](docs/readme/uk-UA.md) | [Русский](docs/readme/ru-RU.md) | [Lietuvių](docs/readme/lt-LT.md) | [Latviešu](docs/readme/lv-LV.md) | [Eesti](docs/readme/et-EE.md) | [Türkçe](docs/readme/tr-TR.md) | [Tiếng Việt](docs/readme/vi-VN.md) | [ไทย](docs/readme/th-TH.md) | [Bahasa Indonesia](docs/readme/id-ID.md) | [Bahasa Melayu](docs/readme/ms-MY.md) | [हिन्दी](docs/readme/hi-IN.md)
...
This project is an architectural upgrade of [Live-Translator-Hub](https://github.com/Uncle-Gao/Live-Translator-Hub) — evolving from a CLI script into a GUI with status panels and real-time logs, merging the localization capabilities for Cursor and Claude into one unified platform.
...
`packages/core/src/translator-engine.js` is the sole runtime injected into target applications — pure browser JS with no module dependencies. Responsibilities include:

- **Dictionary matching**: Static entries + regex patterns
- **AI translation proxy bridge**: Forwards translation requests to the main window via `postMessage` in Webview environments, bypassing CSP network restrictions
...
Manage the localization deployment status, dictionary versions, and blocking rules for Cursor and Claude from the same interface without switching tools.
...
- **Encrypted API key storage**: Saved via Electron `safeStorage` to `~/.live_translator_hub/api_keys.enc`, not written to configuration files
