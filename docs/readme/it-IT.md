...
│   │   ├── electron/preload.js     # Ponte di comunicazione processo di rendering
...
### Gestione Unificata di Due Motori

Gestisci lo stato di distribuzione della localizzazione, le versioni del dizionario e le regole di blocco per Cursor e Claude dalla stessa interfaccia, senza bisogno di cambiare strumento.
